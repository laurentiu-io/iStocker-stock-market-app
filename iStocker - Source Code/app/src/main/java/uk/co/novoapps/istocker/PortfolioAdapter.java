...
public class PortfolioAdapter extends ArrayAdapter<String> {
    ...
    public PortfolioAdapter(Context context, ArrayList<String>  stocksTitles, String[] stocksDates, ArrayList<String> stocksPrices, ArrayList<String> stocksDropPrices) {
        super(context, R.layout.rowmodel_portfolio, stocksTitles);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.rowmodel_portfolio, null);
        }
        ...
        //INITIALIZATIONS
        holder.stocks_title = (TextView) convertView.findViewById(R.id.portfolio_title);
        holder.dateTitleView = (TextView) convertView.findViewById(R.id.dateTitleView);
        holder.stocksPriceView = (TextView) convertView.findViewById(R.id.portfolioPriceView);
        holder.dropPrice = (TextView) convertView.findViewById(R.id.portfolioDropPrice);
