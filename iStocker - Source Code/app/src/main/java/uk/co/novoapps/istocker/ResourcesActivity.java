...
public class ResourcesActivity extends AppCompatActivity implements MaterialTabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabHost = (MaterialTabHost) findViewById(R.id.materialTabHost_resources);
        viewPager = (ViewPager) findViewById(R.id.viewPager_resources);
    ...
    private class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position){
            switch (position) {
                case 0:
                    ...
                    return tab1;
                case 1:
                    DocumentariesFragment tab2 = new DocumentariesFragment();
                    return tab2;
                case 2:
                    WebsitesFragment tab3 = new WebsitesFragment();
                    return tab3;
                default:
                    return null;
            }
        ...
        public CharSequence getPageTitle(int position){
            return getResources().getStringArray(R.array.tabs_resources)[position];
        }
    }
}